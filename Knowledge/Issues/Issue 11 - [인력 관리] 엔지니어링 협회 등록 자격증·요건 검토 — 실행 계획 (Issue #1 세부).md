...
## 2026-06-23 - 진행상황보고 PDF 반영

`docs/엔지니어링협회등록 진행상황보고.pdf`를 확인해 실행계획을 비개발자용 표현으로 다시 정리했습니다.
...
- 후보군은 충분
- 현재 신고 기준은 8명
- 등록요건 10명까지 2명 추가 신고 필요
- 특급/초급 등급 확정에는 경력증명서 확인 필요
- 자본금/사무실은 인력 DB가 아니라 회사 서류로 확인 필요

### 실행계획 보강

- [ ] 후보 2명 추가 신고 대상 확정
- [ ] 특급 후보 경력증명서 우선 확인
- [ ] 초급 이상 10명 충족 여부를 협회 신고 기준으로 재확인
- [ ] 자본금/사무실 증빙 상태를 회사 서류로 확인
- [ ] KIBA 페이지 의견이 GitHub Issue에 들어오면 개발 Plan 항목으로 재분류
- [ ] 비개발자용 그래프 DB를 Quartz/Wiki에 연결

### 연결

- [[Knowledge/Sources/엔지니어링협회등록 그래프 DB|엔지니어링협회등록 그래프 DB]]
