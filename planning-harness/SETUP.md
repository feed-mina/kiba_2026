...
### 5-2. Issues 생성 테스트 (드라이런)

```bash
# 결과 미리 보기
python scripts/create_github_issues.py 2026-06-30 --dry-run

# 출력 예:
# 📋 2026-06-30 회의 - 1개 할 일 항목
# 1. 기획 하네스 초기 설정
#    담당: @담당자1
#    마감: 2026-07-05
```
...
# 확인: GitHub 리포지토리의 Issues 탭에서 생성 확인
```
...
# 확인: GitHub Projects 탭에서 Issues 추가 확인
```
